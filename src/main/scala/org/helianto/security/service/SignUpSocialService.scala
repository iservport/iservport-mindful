...
/**
  * Social sign-up service.
  */
@Service
class SignUpSocialService @Inject()
(connectionFactoryLocator: ConnectionFactoryLocator,connectionRepository: UsersConnectionRepository) {
