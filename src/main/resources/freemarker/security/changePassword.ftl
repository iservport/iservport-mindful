...
<div class="container-small">
    ...
    <div class="well well-lg">
			<form name="form"  id="password" data-ng-submit="updatePassword()" >
				...
				<button type="submit" class="btn btn-primary" style="width: 100%;" data-ng-show="cpassword.length>0 && passwordMatches()">Mudar Senha</button>
			</form>
		</div>
